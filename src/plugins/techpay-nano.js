// Basic functions for communication with techpay nano ledger hw, using techpay-ledgerjs

import TechPayNano from 'techpay-ledgerjs/src/techpay-nano.js';
...
export class FNano {
    ...
    async getVersion() {
        ...
        if (transport) {
            ...
            const bridge = new TechPayNano(transport);
